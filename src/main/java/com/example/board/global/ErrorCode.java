...
public enum ErrorCode {
    ...
    DUPLICATE_NAME(HttpStatus.CONFLICT, "이미 등록된 리소스입니다"),
    DUPLICATE_BOOKMARK(HttpStatus.CONFLICT, "이미 등록된 리소스입니다"),
    NOT_FOUND_BOOKMARK(HttpStatus.NOT_FOUND, "북마크를 찾을 수 없습니다"),
    NO_PERMISSION(HttpStatus.FORBIDDEN, "권한이 없습니다"),
    LOGIN_FAILED(HttpStatus.FORBIDDEN, "아이디와 패스워드를 확인하시기 바랍니다."),
